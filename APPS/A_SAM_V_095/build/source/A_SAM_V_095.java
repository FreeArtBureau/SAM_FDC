 ...
 *
 * - New funcions in Machine class with big help from Julien Gachadoat aka V3GA :
 *
 *   NOTES TO SELF :
 * - add current pos as display INFO - at which point in list are we?
 *
 */
/////////////////////////// LIBRARIES /////////////////////////
...
class Machine {
  ...
  public void draw() {
    ...
    //float
    if (dist(LOC.x, LOC.y, CURRENT_POS.x, CURRENT_POS.y) <= 1.5f)
    {
      LOC.set(CURRENT_POS);
      penDown();
      ARRIVED = true;
...
public void fileSelected(File selection) {
  ...
  public void settings() {  size(1240, 720);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "A_SAM_V_095" };
    if (passedArgs != null) {
